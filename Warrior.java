...
class Warrior extends Brawler implements Character {
	...
	public boolean canAttack(Brawler victim) {
		...
		int defense = (victim.getLevel() + victim.getShieldBonus() + victim.getClericDefenseBonus() - isOrc);
		int attack = (this.getLevel() + this.getSwordBonus() + this.isCharging());
		...
		else if (victim instanceof Princess && !this.isHandsFull()) answer = true;
